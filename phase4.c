...
int safe_transfer(double amount, int from, int to) {
...
void* teller_thread(void* arg) {
    ...
    for (int i = 0; i < TRANSACTIONS_PER_THREAD; i++) {
        ...
        int transfer_result = safe_transfer(amount, account_idx, account_idy);
...
int main() {
    ...
    //threads deadlock here due to the transfer function's account locking
